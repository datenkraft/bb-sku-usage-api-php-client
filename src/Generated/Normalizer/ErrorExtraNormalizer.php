...
class ErrorExtraNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Datenkraft\Backbone\Client\SkuUsageApi\Generated\Model\ErrorExtra::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Datenkraft\Backbone\Client\SkuUsageApi\Generated\Model\ErrorExtra::class;
    }
    ...
    {
        return [\Datenkraft\Backbone\Client\SkuUsageApi\Generated\Model\ErrorExtra::class => false];
    }
}